package com.nabob.conch.sample.advice.agentv2.old;

import com.nabob.conch.sample.advice.EnableRpcLogV2;
import com.nabob.conch.sample.advice.agent.AgentBeanPostProcessor;
 ...
 * 兼容V1版本
 */
public class AgentBeanDefinitionRegistrarDelegator implements ImportBeanDefinitionRegistrar {

    @Override
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        AnnotationAttributes attributes = AnnotationAttributes.fromMap(importingClassMetadata.getAnnotationAttributes(EnableRpcLogV2.class.getName()));
