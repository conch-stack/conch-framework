...
public class ReflectionHelper {
     ...
     * twice, unless excluded by a {@link ltd.beihu.sample.uitl.ReflectionHelper.MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
     * @see #doWithMethods(Class, ltd.beihu.sample.uitl.ReflectionHelper.MethodCallback, ltd.beihu.sample.uitl.ReflectionHelper.MethodFilter)
     */
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@link ltd.beihu.sample.uitl.ReflectionHelper.MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
