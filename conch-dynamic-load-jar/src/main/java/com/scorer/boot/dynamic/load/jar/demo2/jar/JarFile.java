 ...
 * <ul>
 * <li>A nested {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} can be {@link #getNestedJarFile(java.util.zip.ZipEntry) obtained} based
 * on any directory entry.</li>
 * <li>A nested {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} can be {@link #getNestedJarFile(java.util.zip.ZipEntry) obtained} for
...
public class JarFile extends java.util.jar.JarFile {
    ...
    /**
     * Create a new {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} backed by the specified file.
    ...
    /**
     * Private constructor used to create a new {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} either directly or from a
     * nested entry.
    ...
    /**
     * Return a nested {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} loaded from the specified entry.
     * @param entry the zip entry
     * @return a {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile} for the entry
     * @throws java.io.IOException if the nested jar file cannot be read
     */
    ...
    /**
     * The type of a {@link com.scorer.boot.dynamic.load.jar.demo2.jar.JarFile}.
     */
    enum JarFileType {
