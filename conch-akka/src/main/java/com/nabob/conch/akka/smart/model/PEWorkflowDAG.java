package com.nabob.conch.akka.smart.model;
...
public class PEWorkflowDAG implements Serializable {
    ...
    public static class Node implements Serializable {
         ...
         * note type
         *
         * @see com.nabob.conch.akka.smart.enums.WorkflowNodeType
         * @since 20210316
         */
         ...
         *
         * @see com.nabob.conch.akka.smart.enums.WorkflowNodeType#NESTED_WORKFLOW
         */
        private Long jobId;
        /**
         * node name
