...
public class ReflectionHelper {
     ...
     * twice, unless excluded by a {@link ReflectionHelper.MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
     * @see #doWithMethods(Class, ReflectionHelper.MethodCallback, ReflectionHelper.MethodFilter)
     */
     ...
     * <p>The same named method occurring on subclass and superclass will appear
     * twice, unless excluded by the specified {@link ReflectionHelper.MethodFilter}.
     *
     * @param clazz the class to introspect
     * @param mc    the callback to invoke for each method
